...
// This project uses the same url for each env, but demonstrates a simple way to handle multiple environments
if (!ENV || !['local', 'dev', 'qe', 'stage'].includes(ENV)) {
    console.log('Please run the automation against an environment [local|dev|qe|stage]')
    process.exit()
}
